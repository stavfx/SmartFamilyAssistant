...
# def pause_internet(mdn, password):
#     token, _ = auth(mdn, password)
#     overview = get_overview(token)
#     group = overview.group
#     group_id = group.id
#     print("XXX in pause_internet")
#     print(f"XXX group_id={group_id}")
#     print(f"XXX users={overview.users}")
